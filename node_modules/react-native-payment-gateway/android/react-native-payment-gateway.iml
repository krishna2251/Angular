...
<module external.linked.project.id=":react-native-payment-gateway" external.linked.project.path="$MODULE_DIR$" external.root.project.path="$MODULE_DIR$/../../../android" external.system.id="GRADLE" type="JAVA_MODULE" version="4">
  <component name="FacetManager">
    <facet type="android-gradle" name="Android-Gradle">
      <configuration>
        <option name="GRADLE_PROJECT_PATH" value=":react-native-payment-gateway" />
      </configuration>
    </facet>
  ...
  <component name="NewModuleRootManager" LANGUAGE_LEVEL="JDK_1_7">
    ...
    <orderEntry type="library" name="com.facebook.react:react-native-0.50.3" level="project" />
    ...
    <orderEntry type="library" name="com.squareup.okhttp:okhttp:2.3.0@jar" level="project" />
